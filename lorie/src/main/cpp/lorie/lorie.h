...
typedef enum { LORIE_CLIP_FILE } LorieClipItemKind;

// One item of a multi-item clip (see LorieClipboardList). Either data (inline, e.g. small text) or
// fd (an already-open, owned, O_RDONLY file) is set, never both.
typedef struct {
